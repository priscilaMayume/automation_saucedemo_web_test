package com.saucedemo.constantes;

public class Constantes {

    public static final String URL_SAUCEDEMO = "https://www.saucedemo.com/";
    public static final String TITLE_SAUCEDEMO = "Swag Labs";
    ...
    public static final String LOCKED_PROBLEM_USER = "problem_user";
    ...
    public static final String PSW_VALIDO = "secret_sauce";
